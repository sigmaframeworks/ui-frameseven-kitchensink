...
define(["require", "exports", "aurelia-framework", "../sigma-ui-frameseven"], function (require, exports, aurelia_framework_1, sigma_ui_frameseven_1) {
    ...
    var FSPopup = (function () {
        ...
        FSPopup = __decorate([
            ...
            aurelia_framework_1.inlineView('<template class="popup page block"><slot></slot></template>'), 
            __metadata('design:paramtypes', [Element])
        ], FSPopup);
        return FSPopup;
    }());
    ...
    var FSColumn = (function () {
        ...
        FSColumn = __decorate([
            ...
            aurelia_framework_1.inlineView('<template class="col-fill"><slot></slot></template>'), 
            __metadata('design:paramtypes', [])
        ], FSColumn);
        return FSColumn;
    }());
